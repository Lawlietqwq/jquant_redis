...
class StopLossIndicator:
    ...
    def __init__(
        ...
        self.open = self.data["open"].astype("float").reset_index(drop=True)
        self.close = self.data["close"].astype("float").reset_index(drop=True)
        self.high = self.data["high"].astype("float").reset_index(drop=True)
        self.low = self.data["low"].astype("float").reset_index(drop=True)
